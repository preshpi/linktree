        ...
        <p className="text-start text mt-3 lg:w-full md:w-[375px] text-xl font-normal">Hi there, contact me to ask about anything you have in mind.</p>
          ...
          <div className="grid lg:grid-cols-2 lg:gap-5">
            ...
            <div>
              ...
              <input onChange={e=>setLastname(e.target.value)}  className={error&& lastName.length<=0 ? 'errorname mt-3 w-[343px] lg:w-[348px] focus:outline-none border border-[#F83F23]' : 'inputname mt-3  w-[343px] lg:w-[348px] focus:outline-none focus:border focus:border-[#84CAFF]  border border-[#D0D5DD]' } id="last_name" placeholder='Enter your last name'/>
