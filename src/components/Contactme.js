      ...
      <div className="m-5">
        ...
        <p className="text-start text mt-3 lg:w-full md:w-[375px] text-xl font-normal">Hi there, contact me to ask about anything you have in mind.</p>
          ...
          <div className="mt-3">
            ...
            <input onChange={e=>setEmail(e.target.value)}  className={error&& email.length<=0 ? 'errorname mt-3 w-[343px] lg:w-[720px] focus:outline-none border border-[#F83F23]' : 'inputname mt-3  w-[343px] lg:w-[720px] focus:outline-none focus:border focus:border-[#84CAFF]  border border-[#D0D5DD]' } id="email" type="email" placeholder="yourname@email.com" value={email} onChange={handleOnChange}/>
